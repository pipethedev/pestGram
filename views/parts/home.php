...
<div class="min-w-screen min-h-screen bg-gray-100 flex items-center justify-center px-5 py-5">
    <div class="w-full mx-auto rounded-lg border border-gray-700 p-8 lg:py-12 lg:px-14 text-gray-300" style="max-width: 800px" x-data="app()" x-init="addItem()">
        <div class="mb-10">
            <h1 class="text-2xl font-bold text-blue-600"><i class="mdi mdi-star  text-3xl leading-none align-bottom"></i> Todos</h1>
        </div>
        <div class="mb-10">
                <ul  class="-mx-1">
                        <li class="px-2 py-2 rounded transition-all flex text-md" :class="{'bg-indigo-800':item.focused,'bg-gray-700 shadow-lg px-4 py-4 my-10 -mx-2':item.open,'mb-1 cursor-pointer':!item.open}" :key="index">
        ...
        <div class="flex justify-center">
            <button class="py-1 bg-black px-10 rounded leading-none  text-xl"><i class="mdi mdi-plus"></i></button>
        </div>
    </div>
</div>
